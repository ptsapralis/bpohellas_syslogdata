...
CREATE TABLE [dbo].[slfacilities] (
	...
	[slfacilitydesc] varchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
...
CREATE TABLE [dbo].[slseverities] (
	...
	[slseveritydesc] varchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT ('slseverity')
)
GO
...
CREATE TABLE [dbo].[slsourceipaddrs] (
	...
	[slsourceipaddr] varchar(16) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
)
GO
...
CREATE TABLE [dbo].[sltags] (
	...
	[sltagdesc] varchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT ('sltag')
)
GO
...
CREATE TABLE [dbo].[syslogdata] (
	...
	[sldate] varchar(10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[slmsg] varchar(2048) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT ('slmsg'),
