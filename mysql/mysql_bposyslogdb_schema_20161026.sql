...
--
-- Host: mysqldbserver    Database: bposyslogdb
-- ------------------------------------------------------
...
CREATE TABLE `syslogbuffer` (
  ...
  `slrec_shortdateandtime` varchar(32) DEFAULT 'd/m/yyyy hh:mm AM',
...
) ENGINE=InnoDB AUTO_INCREMENT=11466225 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `syslogstage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2016-10-26 17:51:21
