...
CREATE DATABASE [bposyslogdb]
 CONTAINMENT = NONE
 ON  PRIMARY
( NAME = N'bposyslogdbdata', FILENAME = N'c:\\Program Files\\Microsoft SQL Server\\MSSQL13.MSSQLSERVER\\MSSQL\\DATA\\bposyslogdb.dat' , SIZE = 1048576KB , MAXSIZE = 33554432KB , FILEGROWTH = 1048576KB )
 LOG ON
( NAME = N'bposyslogdblog', FILENAME = N'c:\\Program Files\\Microsoft SQL Server\\MSSQL13.MSSQLSERVER\\MSSQL\\DATA\\bposyslogdb.log' , SIZE = 1048576KB , MAXSIZE = 33554432KB , FILEGROWTH = 1048576KB )
END
...
GO
ALTER AUTHORIZATION ON DATABASE::[bposyslogdb] TO [SQLSRV2016DEV\Administrator]
GO
USE [bposyslogdb]
GO
